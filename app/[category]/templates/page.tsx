  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">{cat.label} — Templates</h1>
          <p className="mt-1 text-sm text-muted-foreground">Saved reference captures used to diff future runs against.</p>
        </div>
        <Button render={<Link href={`/${cat.slug}/templates/new`} />} nativeButton={false}>
