...
export default async function LoadEventsDashboardPage() {
  const [allTemplates, recentRunRows] = await Promise.all([
  ...
  return (
    <div className="space-y-10">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Load Events — Run a check</h1>
